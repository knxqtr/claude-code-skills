...
description: Rules for accurate financial calculations — decimal math, fill prices, fee handling, and balance accuracy. Use when code calculates money, prices, PnL, percentages, fees, or account balances. Use when user says "PnL", "profit", "fee", "balance", "price calculation", or "financial math".
---
